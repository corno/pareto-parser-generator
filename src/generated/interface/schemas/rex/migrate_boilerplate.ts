...
export namespace _T_Char_Class_Option {
    ...
    export type RESULT = _i_out._T_Char_Class_Option
}
...
export namespace _T_Context {
    ...
    export type RESULT = _i_out._T_Context
}
...
export namespace _T_Context_Expression {
    ...
    export type RESULT = _i_out._T_Context_Expression
}
...
export namespace _T_Equivalence_Char_Range {
    ...
    export type RESULT = _i_out._T_Equivalence_Char_Range
}
...
export namespace _T_Lexical_Item {
    ...
    export type RESULT = _i_out._T_Lexical_Item
}
...
export namespace _T_Lexical_Sequence {
    ...
    export type RESULT = _i_out._T_Lexical_Sequence
}
...
export namespace _T_Name_Or_String {
    ...
    export type RESULT = _i_out._T_Name_Or_String
}
...
export namespace _T_Syntax_Choice {
    ...
    export type RESULT = _i_out._T_Syntax_Choice
}
...
export namespace _T_Syntax_Production {
    ...
    export type RESULT = _i_out._T_Syntax_Production
}
...
export namespace _T_Syntax_Sequence {
    ...
    export type RESULT = _i_out._T_Syntax_Sequence
}
...
export namespace _T_Whitespace_Option {
    ...
    export type RESULT = _i_out._T_Whitespace_Option
}
